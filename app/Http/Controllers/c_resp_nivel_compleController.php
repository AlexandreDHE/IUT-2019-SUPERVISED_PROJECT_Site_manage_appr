...
class c_resp_nivel_compleController extends Controller
{
    ...
    public function sendData(C_resp_tbaRequest $request, BD_transactions $bd_transactions)
    {
        ...
        $type[0]=4; // Formulaire d'Avancement "BASIQUE" donc 0.
        $type[1]=2; // Le formulaire d'Avancement dispose d'une partie contenant 2 lignes.
        $type[2]=2; // Le formulaire d'Avancement dispose d'une  deuxième partie contenant 2 lignes.
